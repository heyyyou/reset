...
public class AvisExpert { 
	...
	protected LocalDateTime reponseAvisTime;

	


	public LocalDateTime getReponseAvisTime() {
		return reponseAvisTime;
	}

	public void setReponseAvisTime(LocalDateTime reponseAvisTime) {
		this.reponseAvisTime = reponseAvisTime;
	}
	...
	public AvisExpert(String maladieDroite, String maladieGauche, Expert expert, int graviteDroite, int graviteGauche,String commentaireGauche,String commentaireDroite,LocalDateTime reponseAvisTime,String decalageHoraireGen) {
		super();
		this.maladieDroite = maladieDroite;
		this.maladieGauche = maladieGauche;
		this.graviteDroite = graviteDroite;
		...
		this. commentaireDroite= commentaireDroite;
		this.reponseAvisTime=reponseAvisTime;
		this.decalageHoraireGen=decalageHoraireGen;
	}
...
private String decalageHoraireGen ;
	public String getDecalageHoraireGen() {
	return decalageHoraireGen;
}

public void setDecalageHoraireGen(String decalageHoraireGen) {
	this.decalageHoraireGen = decalageHoraireGen;
}
